...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("FomaLSSJ", "LittleAdventure", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "LittleAdventure";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "LittleAdventure", null, { width: 640, height: 480 });
