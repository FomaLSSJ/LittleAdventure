...
HXLINE( 310)		this->liveFilePath = liveFilePath_;
...
HXLINE( 486)				::flixel::FlxG_obj::log->advanced(HX_("Failed to add a widget with the name 'screen', that is reserved by the system for the screen itself",a1,98,88,7b),::flixel::_hx_system::debug::log::LogStyle_obj::NOTICE,null());
            			}
            			else {
HXLINE( 490)				::flixel::FlxG_obj::log->advanced(((HX_("Duplicate screen name '",d1,0b,e0,7e) + key) + HX_("'",27,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::NOTICE,null());
            			}
...
HXDLIN( 527)				::flixel::IFlxSprite_obj::set_x(replace,(original1 + ((Float)(_hx_tmp - ( (Float)(replace->__Field(HX_("get_width",5d,12,0c,0e),hx::paccDynamic)()) )) / (Float)(int)2)));
            			}
...
HXDLIN( 532)				::flixel::IFlxSprite_obj::set_y(replace,(original2 + ((Float)(_hx_tmp1 - ( (Float)(replace->__Field(HX_("get_height",b0,77,d3,f2),hx::paccDynamic)()) )) / (Float)(int)2)));
            			}
...
HXDLIN( 696)					if (hx::IsNotNull( this->liveFilePath )) {
HXLINE( 696)						_hx_tmp = (this->liveFilePath != HX_("",00,00,00,00));
            					}
            					else {
...
HXLINE( 700)							liveFile = ::flixel::addons::ui::U_obj::readFast(::flixel::addons::ui::U_obj::fixSlash(((this->liveFilePath + inc_name) + HX_(".xml",69,3e,c3,1e))));
            						}
            						catch( ::Dynamic _hx_e){
            							if (_hx_e.IsClass< ::String >() ){
            								HX_STACK_BEGIN_CATCH
            								::String msg = _hx_e;
HXLINE( 704)								::flixel::FlxG_obj::log->advanced(msg,::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE( 705)								liveFile = null();
            							}
            							else {
...
HXLINE( 784)							::flixel::FlxG_obj::log->advanced(((((HX_("Can't create FlxUI definition '",b5,82,49,00) + def_name1) + HX_("', because '",92,6b,a1,0c)) + error) + HX_("' is a reserved name prefix!",16,78,51,ae)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            						}
            						else {
...
HXLINE( 863)								_hx_tmp1 = ::Std_obj::is(result,hx::ClassOf< ::flixel::addons::ui::FlxUIGroup >());
            							}
            							else {
...
HXLINE(1790)							HX_STACK_DO_THROW(((HX_("couldn't load bmp \"",73,a2,6e,30) + HX_("arrow",c9,79,8f,25)) + HX_("\"",22,00,00,00)));
            						...
            						if (_hx_e.IsClass< ::String >() ){
            							HX_STACK_BEGIN_CATCH
            							::String msg = _hx_e;
HXLINE(1790)							::flixel::FlxG_obj::log->advanced((HX_("FlxUI: U.xml_gfx() : ",f9,3c,00,4f) + msg),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            						}
            						else {
            							HX_STACK_DO_THROW(_hx_e);
            						}
...
HXLINE(2143)							::flixel::FlxG_obj::log->advanced(boundsError,::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            						}
            					}
            				}
            			}
...
HXLINE(2337)		Float ww = ( (Float)(fo_r->__Field(HX_("get_width",5d,12,0c,0e),hx::paccDynamic)()) );
HXLINE(2338)		Float hh = ( (Float)(fo_r->__Field(HX_("get_height",b0,77,d3,f2),hx::paccDynamic)()) );
...
HXLINE(3044)					::flixel::FlxG_obj::log->advanced(((HX_("couldn't loadButton with definition \"",2d,5f,ac,2b) + button_def) + HX_("\"",22,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,null());
...
HXLINE(3053)					::flixel::FlxG_obj::log->advanced(((HX_("couldn't loadText with definition \"",a8,f1,da,63) + label_def) + HX_("\"",22,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,null());
...
HXLINE(3084)							::flixel::FlxG_obj::log->advanced(((HX_("couldn't loadButton with definition \"",2d,5f,ac,2b) + def_name) + HX_("\"",22,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,null());
            						}
            						else {
            							HX_STACK_DO_THROW(_hx_e);
            						}
...
HXDLIN(3416)					_g1->set_y((_g2 + ( (Float)(list_tabs->__get((int)0)->__Field(HX_("get_height",b0,77,d3,f2),hx::paccDynamic)()) )));
            				}
...
HXLINE(3908)						HX_STACK_DO_THROW(((HX_("couldn't load bmp \"",73,a2,6e,30) + HX_("src",e4,a6,57,00)) + HX_("\"",22,00,00,00)));
            					...
            					if (_hx_e.IsClass< ::String >() ){
            						HX_STACK_BEGIN_CATCH
            						::String msg = _hx_e;
HXLINE(3908)						::flixel::FlxG_obj::log->advanced((HX_("FlxUI: U.xml_gfx() : ",f9,3c,00,4f) + msg),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            					}
            					else {
            						HX_STACK_DO_THROW(_hx_e);
            					}
...
HXLINE(3978)						HX_STACK_DO_THROW(((HX_("couldn't load bmp \"",73,a2,6e,30) + srcString) + HX_("\"",22,00,00,00)));
            					...
            					if (_hx_e.IsClass< ::String >() ){
            						HX_STACK_BEGIN_CATCH
            						::String msg = _hx_e;
HXLINE(3978)						::flixel::FlxG_obj::log->advanced((HX_("FlxUI: U.xml_gfx() : ",f9,3c,00,4f) + msg),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            					}
            					else {
            						HX_STACK_DO_THROW(_hx_e);
            					}
...
HXLINE(4400)						HX_STACK_DO_THROW(((HX_("couldn't load bmp \"",73,a2,6e,30) + attName) + HX_("\"",22,00,00,00)));
            					...
            					if (_hx_e.IsClass< ::String >() ){
            						HX_STACK_BEGIN_CATCH
            						::String msg = _hx_e;
HXLINE(4400)						::flixel::FlxG_obj::log->advanced((HX_("FlxUI: U.xml_gfx() : ",f9,3c,00,4f) + msg),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            					}
            					else {
            						HX_STACK_DO_THROW(_hx_e);
            					}
...
HXDLIN(4970)				::flixel::IFlxSprite_obj::set_x(thing,((Float)(_hx_tmp2 - ( (Float)(thing->__Field(HX_("get_width",5d,12,0c,0e),hx::paccDynamic)()) )) / (Float)(int)2));
            			}
HXDLIN(4970)			if (ctrY) {
HXLINE(4970)				int _hx_tmp3 = ::flixel::FlxG_obj::height;
HXDLIN(4970)				::flixel::IFlxSprite_obj::set_y(thing,((Float)(_hx_tmp3 - ( (Float)(thing->__Field(HX_("get_height",b0,77,d3,f2),hx::paccDynamic)()) )) / (Float)(int)2));
            			}
            		}
...
HXLINE( 147)			::flixel::FlxG_obj::log->advanced(((HX_("could not call getEvent() for FlxUI event \"",26,83,34,a8) + name) + HX_("\" because current state is not a FlxUIState.\nSolution: state should extend FlxUIState, implement IEventGetter. Otherwise, set broadcastToFlxUI=false for your IFlxUIWidget to supress the events.",01,a8,5f,54)),::flixel::_hx_system::debug::log::LogStyle_obj::NOTICE,null());
            		}
            	}
...
HXLINE( 254)			::flixel::FlxG_obj::log->advanced(HX_("Warning, FlxUI event not handled, IFlxUIWidgets need to exist within an IFlxUIState",71,f5,8f,fb),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            		}
...
HXDLIN(1469)			::flixel::IFlxSprite_obj::set_x(thing,((Float)(_hx_tmp - ( (Float)(thing->__Field(HX_("get_width",5d,12,0c,0e),hx::paccDynamic)()) )) / (Float)(int)2));
            		}
HXLINE(1470)		if (Y) {
HXLINE(1470)			int _hx_tmp1 = ::flixel::FlxG_obj::height;
HXDLIN(1470)			::flixel::IFlxSprite_obj::set_y(thing,((Float)(_hx_tmp1 - ( (Float)(thing->__Field(HX_("get_height",b0,77,d3,f2),hx::paccDynamic)()) )) / (Float)(int)2));
            		}
