...
HXDLIN( 245)			::flixel::IFlxSprite_obj::set_x(_hx_tmp,((_hx_tmp1 - ( (Float)(this->prevButton->__Field(HX_("get_width",5d,12,0c,0e),hx::paccDynamic)()) )) - (int)2));
...
HXDLIN( 251)			::flixel::IFlxSprite_obj::set_y(_hx_tmp4,((_hx_tmp5 - ( (Float)(this->prevButton->__Field(HX_("get_height",b0,77,d3,f2),hx::paccDynamic)()) )) - (int)2));
