...
HXDLIN( 406)								Float dx = ((w3 + ((Float)( (Float)(w->__Field(HX_("get_width",5d,12,0c,0e),hx::paccDynamic)()) ) / (Float)(int)2)) - X);
HXLINE( 407)								Float w4 = ( (Float)(w->__Field(HX_("y",79,00,00,00),hx::paccDynamic)) );
HXDLIN( 407)								Float dy = ((w4 + ((Float)( (Float)(w->__Field(HX_("get_height",b0,77,d3,f2),hx::paccDynamic)()) ) / (Float)(int)2)) - Y);
...
HXDLIN( 430)						Float dx1 = ((w8 + ((Float)( (Float)(w5->__Field(HX_("get_width",5d,12,0c,0e),hx::paccDynamic)()) ) / (Float)(int)2)) - X);
HXLINE( 431)						Float w9 = ( (Float)(w5->__Field(HX_("y",79,00,00,00),hx::paccDynamic)) );
HXDLIN( 431)						Float dy1 = ((w9 + ((Float)( (Float)(w5->__Field(HX_("get_height",b0,77,d3,f2),hx::paccDynamic)()) ) / (Float)(int)2)) - Y);
