...
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_467_removeChild_openfl__legacy_text_TextField,"flixel.FlxG","removeChild_openfl__legacy_text_TextField",0x8174a9f3,"flixel.FlxG.removeChild_openfl__legacy_text_TextField","flixel/FlxG.hx",467,0x8e176836)
...
bool FlxG_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_legacy::text::TextField FlxG_obj::removeChild_openfl__legacy_text_TextField( ::openfl::_legacy::text::TextField Child){
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_467_removeChild_openfl__legacy_text_TextField)
HXLINE( 468)		if (::flixel::FlxG_obj::game->contains(Child)) {
HXLINE( 469)			::flixel::FlxG_obj::game->removeChild(Child);
            		}
...
HXLINE( 573)		 ::flixel::_hx_system::frontEnds::InputFrontEnd _hx_tmp2 = ::flixel::FlxG_obj::inputs;
HXDLIN( 573)		::flixel::FlxG_obj::touches = _hx_tmp2->add_flixel_input_touch_FlxTouchManager( ::flixel::input::touch::FlxTouchManager_obj::__alloc( HX_CTX ));
HXLINE( 577)		 ::flixel::_hx_system::frontEnds::InputFrontEnd _hx_tmp3 = ::flixel::FlxG_obj::inputs;
HXDLIN( 577)		::flixel::FlxG_obj::gamepads = _hx_tmp3->add_flixel_input_gamepad_FlxGamepadManager( ::flixel::input::gamepad::FlxGamepadManager_obj::__alloc( HX_CTX ));
