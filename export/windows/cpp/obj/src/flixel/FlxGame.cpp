...
HXLINE( 633)		{
HXLINE( 633)			 ::Dynamic anyObject = this->_state;
HXDLIN( 633)			::haxe::IMap_obj::set(this->debugger->console->registeredObjects,HX_("state",11,76,0b,84),anyObject);
HXDLIN( 633)			::flixel::_hx_system::debug::console::ConsoleUtil_obj::registerObject(HX_("state",11,76,0b,84),anyObject);
            		}
            	}
