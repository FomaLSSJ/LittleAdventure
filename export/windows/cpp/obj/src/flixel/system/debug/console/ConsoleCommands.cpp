...
HXLINE(  27)		{
HXLINE(  27)			 ::Dynamic func = this->help_dyn();
HXDLIN(  27)			::haxe::IMap_obj::set(console->registeredFunctions,HX_("help",c1,32,0b,45),func);
...
HXLINE(  28)		{
HXLINE(  28)			 ::Dynamic func1 = this->close_dyn();
HXDLIN(  28)			::haxe::IMap_obj::set(console->registeredFunctions,HX_("close",b8,17,63,48),func1);
...
HXLINE(  30)		{
HXLINE(  30)			 ::Dynamic func2 = this->_console->history->clear_dyn();
HXDLIN(  30)			::haxe::IMap_obj::set(console->registeredFunctions,HX_("clearHistory",47,e7,c5,3f),func2);
...
HXLINE(  31)		{
HXLINE(  31)			 ::Dynamic func3 = ::flixel::FlxG_obj::log->clear_dyn();
HXDLIN(  31)			::haxe::IMap_obj::set(console->registeredFunctions,HX_("clearLog",f7,50,0e,31),func3);
...
HXLINE(  33)		{
HXLINE(  33)			 ::Dynamic func4 = this->fields_dyn();
HXDLIN(  33)			::haxe::IMap_obj::set(console->registeredFunctions,HX_("fields",79,8e,8e,80),func4);
...
HXLINE(  35)		{
HXLINE(  35)			 ::Dynamic func5 = this->listObjects_dyn();
HXDLIN(  35)			::haxe::IMap_obj::set(console->registeredFunctions,HX_("listObjects",16,dc,4e,39),func5);
...
HXLINE(  36)		{
HXLINE(  36)			 ::Dynamic func6 = this->listFunctions_dyn();
HXDLIN(  36)			::haxe::IMap_obj::set(console->registeredFunctions,HX_("listFunctions",1d,52,37,c0),func6);
...
HXLINE(  38)		{
HXLINE(  38)			 ::Dynamic func7 = this->step_dyn();
HXDLIN(  38)			::haxe::IMap_obj::set(console->registeredFunctions,HX_("step",4c,e7,5b,4c),func7);
...
HXLINE(  39)		{
HXLINE(  39)			 ::Dynamic func8 = this->pause_dyn();
HXDLIN(  39)			::haxe::IMap_obj::set(console->registeredFunctions,HX_("pause",f6,d6,57,bd),func8);
...
HXLINE(  41)		{
HXLINE(  41)			 ::Dynamic func9 = ::flixel::FlxG_obj::bitmapLog->clear_dyn();
HXDLIN(  41)			::haxe::IMap_obj::set(console->registeredFunctions,HX_("clearBitmapLog",88,b0,e0,84),func9);
...
HXLINE(  42)		{
HXLINE(  42)			 ::Dynamic func10 = ::flixel::FlxG_obj::bitmapLog->viewCache_dyn();
HXDLIN(  42)			::haxe::IMap_obj::set(console->registeredFunctions,HX_("viewCache",9d,09,a9,81),func10);
...
HXLINE(  44)		{
HXLINE(  44)			 ::Dynamic func11 = this->create_dyn();
HXDLIN(  44)			::haxe::IMap_obj::set(console->registeredFunctions,HX_("create",fc,66,0f,7c),func11);
...
HXLINE(  46)		{
HXLINE(  46)			 ::Dynamic func12 = ::flixel::FlxG_obj::watch->add_dyn();
HXDLIN(  46)			::haxe::IMap_obj::set(console->registeredFunctions,HX_("watch",4f,16,25,c5),func12);
...
HXLINE(  47)		{
HXLINE(  47)			 ::Dynamic func13 = ::flixel::FlxG_obj::watch->addExpression_dyn();
HXDLIN(  47)			::haxe::IMap_obj::set(console->registeredFunctions,HX_("watchExpression",c7,c4,8f,8c),func13);
...
HXLINE(  48)		{
HXLINE(  48)			 ::Dynamic func14 = this->watchMouse_dyn();
HXDLIN(  48)			::haxe::IMap_obj::set(console->registeredFunctions,HX_("watchMouse",56,31,6f,84),func14);
...
HXLINE(  49)		{
HXLINE(  49)			 ::Dynamic func15 = ::flixel::FlxG_obj::debugger->track_dyn();
HXDLIN(  49)			::haxe::IMap_obj::set(console->registeredFunctions,HX_("track",8b,8e,1f,16),func15);
...
HXLINE(  70)		{
HXLINE(  70)			 ::Dynamic anyObject = hx::ClassOf< ::flixel::_hx_system::debug::FlxDebuggerLayout >();
HXDLIN(  70)			::haxe::IMap_obj::set(console->registeredObjects,HX_("FlxDebuggerLayout",9d,d1,b4,d8),anyObject);
