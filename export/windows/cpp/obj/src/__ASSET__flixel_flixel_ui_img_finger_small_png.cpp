...
HXLINE(2078)		 ::openfl::_legacy::utils::ByteArray byteArray = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::__ASSET__flixel_flixel_ui_img_finger_small_png_obj::resourceName));
...
HXDLIN(   1)		resourceName = HX_("__ASSET__:bitmap___ASSET__flixel_flixel_ui_img_finger_small_png",58,93,8a,27);
            	}
}
