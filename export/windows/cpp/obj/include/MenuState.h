...
class HXCPP_CLASS_ATTRIBUTES MenuState_obj : public  ::flixel::FlxState_obj
{
	...
	public:
		...
		::String __ToString() const { return HX_HCSTRING("MenuState","\xd2","\xbf","\xb6","\xc0"); }
		 ...
		 ::flixel::text::FlxText statusMessage;
		 ::flixel::addons::text::FlxTextField labelName;
		 ::flixel::addons::ui::FlxInputText inputName;
		 ::flixel::addons::text::FlxTextField labelPass;
		 ::flixel::addons::ui::FlxInputText inputPass;
		 ::flixel::ui::FlxButton requestButton;
		void create();
