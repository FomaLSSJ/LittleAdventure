...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("LittleAdventure", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("LittleAdventure", null, 640, 480);
		#end
		#else
		create (null);
		#end
		...
		var projectName = "LittleAdventure";
	...
	public static function create (config):Void {
		...
		app.meta["build"] = "31";
		app.meta["company"] = "FomaLSSJ";
		app.meta["file"] = "LittleAdventure";
		app.meta["name"] = "LittleAdventure";
